...
const Login = () => {
    return (
                ...
                <div>
                    ...
                    <div className='mt-10 border-b pb-10'>
                        ...
                        <div className='flex flex-wrap gap-x-10 gap-y-6'>
                            <Input LabelText='Email address' placeholder='your Email address' type='email' className='w-[508px]' />
        ...
        //                     <input type="email" name="email" id="email" placeholder="leroy@jenkins.com" className="w-full px-3 py-2 border rounded-md outline-none" />
        //                 </div>
        //                 <div>
